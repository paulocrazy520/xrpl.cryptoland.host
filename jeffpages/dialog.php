            ...
            <ul class="cs-history_list">
              <li>
                <div class="cs-media cs-style1">
                  <div class="cs-media_thumb">
                    <img src="assets/img/avatar/avatar_1.png" alt="" />
                  </div>
                  <div class="cs-media_info">
                    <h3 class="cs-media_title">
              ...
              <li>
                <div class="cs-media cs-style1">
                  <div class="cs-media_thumb">
                    <img src="assets/img/avatar/avatar_3.png" alt="" />
                  </div>
                  <div class="cs-media_info">
    ...
    <!-- Start Modal -->
    <div class="cs-modal_wrap" id="listItem">
      <div class="cs-modal_overlay"></div>
      <div class="cs-modal_container">
        <div class="cs-modal_container_in">
          <div class="cs-modal_close cs-center">
          ...
          <div class="cs-bid_card">
            <h2 class="cs-title_title">List Item(Nft Token Id)</h2>
            <h4 style="overflow-wrap:break-word" id="nft_id"></h4>
            <div class="cs-bid_info">
              ...
              <button class="cs-btn cs-style1 cs-btn_lg w-100" id="btn-list-item">
                <span>List Item</span>
              </button>
            </div>
          </div>
    ...
    <div class="cs-modal_wrap" id="loginModal">
      ...
      <div class="cs-modal_container">
        <div class="cs-modal_container_in">
          <div class="cs-bid_card">
            <h2 class="cs-title_title">Login User</h2>
            <h4 style="overflow-wrap:break-word" id="nft_id"></h4>
            <div class="cs-bid_info">
              ...
              <div class="cs-bid_form_head">
              <input type="text" class="cs-bid_quantity" placeholder="clUserProL1" id="user_name" value="clUserProL1"/>
                <input type="password" class="cs-bid_quantity" placeholder="xP@~~w0rd@2o22x" id="user_password" value="xP@~~w0rd@2o22x"/>
              </div>

              <div class="cs-height_20 cs-height_lg_20"></div>

              <div class="cs-height_25 cs-height_lg_25"></div>
              <button class="cs-btn cs-style1 cs-btn_lg w-100" id="btn_login">
                <span>Login</span>
              </button>
    ...
    <!-- End Modal -->
      ...
      <div class="cs-modal_container">
        <div class="cs-modal_container_in">
          ...
          <div class="cs-bid_card">
            <h2 class="cs-title_title">Place a Bid(Nft Token Id, Owner)</h2>
            <h4 style="overflow-wrap:break-word" id="nft_id"></h4>
            <h4 style="overflow-wrap:break-word" id="owner"></h4>
            <div class="cs-bid_info">
              ...
              <div class="cs-bid_form_head">
                ...
                <span  style="width:30%;">Expire</span>
              </div>
              <div class="cs-bid_form_head">
                <div class="cs-form_field_wrap cs-select_arrow"  style="width:30%;">
                        <select class="cs-form_field cs-field_sm">
                          <option value="BTC">XRP</option>
                          <option value="CRYPTO">CRYPTO</option>
                        </select>
              ...
              <div class="cs-height_25 cs-height_lg_25"></div>
              <button class="cs-btn cs-style1 cs-btn_lg w-100" id="btn-place-item">
