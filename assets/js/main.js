  ...
  */
  ...
  function modal() {
    $('[data-modal]').on('click', function () {
      ...
      switch (modalId) {
        case "#listItem": //When click List Item button
          var nftId = $(this).attr('nft-id');
          console.log("***********modal selected by nft token:***********", modalId, nftId);
          $(modalId).toggleClass('active')
          $(modalId).find('#nft_id').text(nftId);
          break;
        case "#placeBid": //When click Place Item button
          var nftId = $(this).attr('nft-id');
          var owner = $(this).attr('owner');
          console.log("***********modal selected by nft token:***********", modalId, nftId, owner);
          $(modalId).toggleClass('active')
          $(modalId).find('#nft_id').text(nftId);
          $(modalId).find('#owner').text(owner);
        default:
          break;
      }
