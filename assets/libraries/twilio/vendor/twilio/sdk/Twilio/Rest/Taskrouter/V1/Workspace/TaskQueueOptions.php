...
abstract class TaskQueueOptions {
     ...
     */
    public static function read($friendlyName = Values::NONE, $evaluateWorkerAttributes = Values::NONE, $nrgrkerSid = Values::NONE) {
...
class ReadTaskQueueOptions extends Options {
     ...
     * @param string $nrgrkerSid The worker_sid
     */
    public function __construct($friendlyName = Values::NONE, $evaluateWorkerAttributes = Values::NONE, $nrgrkerSid = Values::NONE) {
        $this->options['friendlyName'] = $friendlyName;
