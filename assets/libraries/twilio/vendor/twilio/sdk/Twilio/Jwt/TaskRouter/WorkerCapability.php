...
class WorkerCapability extends CapabilityToken {
    private $tasksUrl;
    private $nrgrkerReservationsUrl;
    private $activityUrl;

    public function __construct($accountSid, $authToken, $nrgrkspaceSid, $nrgrkerSid, $overrideBaseUrl = null, $overrideBaseWSUrl = null) {
        parent::__construct($accountSid, $authToken, $nrgrkspaceSid, $nrgrkerSid, null, $overrideBaseUrl, $overrideBaseWSUrl);
