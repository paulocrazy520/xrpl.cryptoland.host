 ...
 * @property WorkerChannelList $nrgrkerChannels
...
class WorkerContext extends InstanceContext {
     ...
     * @param string $nrgrkspaceSid The SID of the Workspace with the Worker to fetch
    ...
    public function __construct(Version $version, $nrgrkspaceSid, $sid) {
        ...
        // Path Solution
        $this->solution = ['workspaceSid' => $nrgrkspaceSid, 'sid' => $sid, ];

        $this->uri = '/Workspaces/' . \rawurlencode($nrgrkspaceSid) . '/Workers/' . \rawurlencode($sid) . '';
    }
