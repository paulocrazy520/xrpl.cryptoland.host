...
class WorkerChannelContext extends InstanceContext {
     ...
     * @param string $nrgrkspaceSid The SID of the Workspace with the WorkerChannel
     *                             to fetch
     * @param string $nrgrkerSid The SID of the Worker with the WorkerChannel to
     *                          fetch
     * @param string $sid The SID of the to fetch
     */
    public function __construct(Version $version, $nrgrkspaceSid, $nrgrkerSid, $sid) {
        parent::__construct($version);

        // Path Solution
        $this->solution = ['workspaceSid' => $nrgrkspaceSid, 'workerSid' => $nrgrkerSid, 'sid' => $sid, ];

        $this->uri = '/Workspaces/' . \rawurlencode($nrgrkspaceSid) . '/Workers/' . \rawurlencode($nrgrkerSid) . '/Channels/' . \rawurlencode($sid) . '';
    }
