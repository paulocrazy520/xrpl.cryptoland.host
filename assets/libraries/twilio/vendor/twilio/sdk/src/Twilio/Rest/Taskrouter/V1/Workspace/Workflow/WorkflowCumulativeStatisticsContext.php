...
class WorkflowCumulativeStatisticsContext extends InstanceContext {
     ...
     * @param string $nrgrkspaceSid The SID of the Workspace with the resource to
     *                             fetch
     * @param string $nrgrkflowSid Returns the list of Tasks that are being
    ...
    public function __construct(Version $version, $nrgrkspaceSid, $nrgrkflowSid) {
        ...
        // Path Solution
        $this->solution = ['workspaceSid' => $nrgrkspaceSid, 'workflowSid' => $nrgrkflowSid, ];

        $this->uri = '/Workspaces/' . \rawurlencode($nrgrkspaceSid) . '/Workflows/' . \rawurlencode($nrgrkflowSid) . '/CumulativeStatistics';
    }
