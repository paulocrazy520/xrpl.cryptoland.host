...
class ReservationContext extends InstanceContext {
     ...
     */
    public function __construct(Version $version, $nrgrkspaceSid, $taskSid, $sid) {
        parent::__construct($version);

        // Path Solution
        $this->solution = ['workspaceSid' => $nrgrkspaceSid, 'taskSid' => $taskSid, 'sid' => $sid, ];

        $this->uri = '/Workspaces/' . \rawurlencode($nrgrkspaceSid) . '/Tasks/' . \rawurlencode($taskSid) . '/Reservations/' . \rawurlencode($sid) . '';
    }
