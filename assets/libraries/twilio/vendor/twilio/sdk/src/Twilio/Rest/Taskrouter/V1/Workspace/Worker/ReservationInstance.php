 ...
 * @property string $nrgrkerName
 * @property string $nrgrkerSid
...
class ReservationInstance extends InstanceResource {
     ...
     * @param string $nrgrkspaceSid The SID of the Workspace that this worker is
     *                             contained within.
     * @param string $nrgrkerSid The SID of the reserved Worker resource
     * @param string $sid The SID of the WorkerReservation resource to fetch
     */
    public function __construct(Version $version, array $payload, string $nrgrkspaceSid, string $nrgrkerSid, string $sid = null) {
