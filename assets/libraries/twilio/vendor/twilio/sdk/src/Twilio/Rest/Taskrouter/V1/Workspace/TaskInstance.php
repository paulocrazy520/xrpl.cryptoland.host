 ...
 * @property string $nrgrkflowSid
 * @property string $nrgrkflowFriendlyName
 * @property string $nrgrkspaceSid
 * @property string $url
...
class TaskInstance extends InstanceResource {
     ...
     * @param string $nrgrkspaceSid The SID of the Workspace that contains the Task
     * @param string $sid The SID of the resource to fetch
     */
    public function __construct(Version $version, array $payload, string $nrgrkspaceSid, string $sid = null) {
        ...
        $this->solution = ['workspaceSid' => $nrgrkspaceSid, 'sid' => $sid ?: $this->properties['sid'], ];
    }
