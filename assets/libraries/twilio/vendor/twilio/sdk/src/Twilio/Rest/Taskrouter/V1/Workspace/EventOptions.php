...
abstract class EventOptions {
     ...
     * @param string $nrgrkerSid The SID of the Worker with the Events to read
     * @param string $nrgrkflowSid The SID of the Worker with the Events to read
     * @param string $taskChannel The TaskChannel with the Events to read
     * @param string $sid The unique string that identifies the resource
     * @return ReadEventOptions Options builder
     */
    public static function read(\DateTime $endDate = Values::NONE, string $eventType = Values::NONE, int $minutes = Values::NONE, string $reservationSid = Values::NONE, \DateTime $startDate = Values::NONE, string $taskQueueSid = Values::NONE, string $taskSid = Values::NONE, string $nrgrkerSid = Values::NONE, string $nrgrkflowSid = Values::NONE, string $taskChannel = Values::NONE, string $sid = Values::NONE): ReadEventOptions {
        return new ReadEventOptions($endDate, $eventType, $minutes, $reservationSid, $startDate, $taskQueueSid, $taskSid, $nrgrkerSid, $nrgrkflowSid, $taskChannel, $sid);
    }
}
...
class ReadEventOptions extends Options {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    public function __construct(\DateTime $endDate = Values::NONE, string $eventType = Values::NONE, int $minutes = Values::NONE, string $reservationSid = Values::NONE, \DateTime $startDate = Values::NONE, string $taskQueueSid = Values::NONE, string $taskSid = Values::NONE, string $nrgrkerSid = Values::NONE, string $nrgrkflowSid = Values::NONE, string $taskChannel = Values::NONE, string $sid = Values::NONE) {
