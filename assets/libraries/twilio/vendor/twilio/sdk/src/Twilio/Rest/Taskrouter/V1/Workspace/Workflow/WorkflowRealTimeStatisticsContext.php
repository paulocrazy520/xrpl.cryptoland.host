...
class WorkflowRealTimeStatisticsContext extends InstanceContext {
     ...
     * @param string $nrgrkspaceSid The SID of the Workspace with the Workflow to
     *                             fetch
    ...
    public function __construct(Version $version, $nrgrkspaceSid, $nrgrkflowSid) {
        ...
        $this->uri = '/Workspaces/' . \rawurlencode($nrgrkspaceSid) . '/Workflows/' . \rawurlencode($nrgrkflowSid) . '/RealTimeStatistics';
    }
