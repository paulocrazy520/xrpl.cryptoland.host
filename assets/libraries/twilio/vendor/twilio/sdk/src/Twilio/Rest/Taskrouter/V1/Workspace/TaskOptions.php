...
abstract class TaskOptions {
     ...
     *                                   assignment_status
     * @param string $nrgrkflowSid The SID of the Workflow with the Tasks to read
     * @param string $nrgrkflowName The friendly name of the Workflow with the Tasks
     *                             to read
     ...
     */
    public static function read(int $priority = Values::NONE, array $assignmentStatus = Values::ARRAY_NONE, string $nrgrkflowSid = Values::NONE, string $nrgrkflowName = Values::NONE, string $taskQueueSid = Values::NONE, string $taskQueueName = Values::NONE, string $evaluateTaskAttributes = Values::NONE, string $ordering = Values::NONE, bool $hasAddons = Values::NONE): ReadTaskOptions {
        return new ReadTaskOptions($priority, $assignmentStatus, $nrgrkflowSid, $nrgrkflowName, $taskQueueSid, $taskQueueName, $evaluateTaskAttributes, $ordering, $hasAddons);
    }
     ...
     *                            SID
     * @param string $nrgrkflowSid The SID of the Workflow that you would like to
     ...
     */
    public static function create(int $timeout = Values::NONE, int $priority = Values::NONE, string $taskChannel = Values::NONE, string $nrgrkflowSid = Values::NONE, string $attributes = Values::NONE): CreateTaskOptions {
        return new CreateTaskOptions($timeout, $priority, $taskChannel, $nrgrkflowSid, $attributes);
    }
}
...
class ReadTaskOptions extends Options {
     ...
     * @param bool $hasAddons Whether to read Tasks with addons
     */
    public function __construct(int $priority = Values::NONE, array $assignmentStatus = Values::ARRAY_NONE, string $nrgrkflowSid = Values::NONE, string $nrgrkflowName = Values::NONE, string $taskQueueSid = Values::NONE, string $taskQueueName = Values::NONE, string $evaluateTaskAttributes = Values::NONE, string $ordering = Values::NONE, bool $hasAddons = Values::NONE) {
        $this->options['priority'] = $priority;
        $this->options['assignmentStatus'] = $assignmentStatus;
        $this->options['workflowSid'] = $nrgrkflowSid;
        $this->options['workflowName'] = $nrgrkflowName;
     ...
     * @return $this Fluent Builder
     */
    public function setWorkflowSid(string $nrgrkflowSid): self {
        $this->options['workflowSid'] = $nrgrkflowSid;
        return $this;
    }
     ...
     * @return $this Fluent Builder
     */
    public function setWorkflowName(string $nrgrkflowName): self {
        $this->options['workflowName'] = $nrgrkflowName;
        return $this;
    }
...
class CreateTaskOptions extends Options {
     ...
     *                           attributes of the task
     */
    public function __construct(int $timeout = Values::NONE, int $priority = Values::NONE, string $taskChannel = Values::NONE, string $nrgrkflowSid = Values::NONE, string $attributes = Values::NONE) {
