...
class ReservationContext extends InstanceContext {
     ...
     * @param string $nrgrkspaceSid The SID of the Workspace with the
     *                             WorkerReservation resource to fetch
     * @param string $nrgrkerSid The SID of the reserved Worker resource with the
     *                          WorkerReservation resource to fetch
    ...
    public function __construct(Version $version, $nrgrkspaceSid, $nrgrkerSid, $sid) {
        ...
        $this->uri = '/Workspaces/' . \rawurlencode($nrgrkspaceSid) . '/Workers/' . \rawurlencode($nrgrkerSid) . '/Reservations/' . \rawurlencode($sid) . '';
    }
