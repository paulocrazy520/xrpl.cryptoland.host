...
class OdnoklassnikiSDK{
    ...
    public static function SetOkInfo()
    {
        global $nrg;
        self::$app_id = $nrg['config']['OkAppId'];
        self::$app_public_key = $nrg['config']['OkAppPublickey'];
        self::$app_secret_key = $nrg['config']['OkAppSecretkey'];
        self::$redirect_url = $nrg['config']['site_url']."/login-with.php";
    }
}
?>
