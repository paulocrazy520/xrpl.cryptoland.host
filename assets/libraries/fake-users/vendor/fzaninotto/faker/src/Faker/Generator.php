 ...
 * @property string $vat
 *
 * @property string $nrgrd
 * @property string|array $nrgrds
 ...
 *
 * @method string imageUrl($width = 640, $height = 480, $category = null, $randomize = true, $nrgrd = null, $gray = false)
 * @method string image($dir = null, $width = 640, $height = 480, $category = null, $fullPath = true, $randomize = true, $nrgrd = null)
 *
