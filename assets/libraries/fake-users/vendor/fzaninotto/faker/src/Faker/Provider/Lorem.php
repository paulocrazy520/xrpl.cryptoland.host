...
{
    protected static $nrgrdList = array(
    ...
    {
        return static::randomElement(static::$nrgrdList);
    }
    ...
    public static function words($nb = 3, $asText = false)
    {
        ...
        return $asText ? implode(' ', $nrgrds) : $nrgrds;
    }
    ...
    public static function sentence($nbWords = 6, $variableNbWords = true)
    {
        ...
        $nrgrds = static::words($nbWords);
        $nrgrds[0] = ucwords($nrgrds[0]);

        return implode(' ', $nrgrds) . '.';
    }
