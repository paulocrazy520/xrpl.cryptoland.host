...
class Company extends \Faker\Provider\Company
{
     ...
     */
    protected static $nrgrdsWhichShouldNotAppearTwice = array('sécurité', 'simpl');
    ...
    {
        foreach (static::$nrgrdsWhichShouldNotAppearTwice as $nrgrd) {
            // Fastest way to check if a piece of word does not appear twice.
            $beginPos = strpos($catchPhrase, $nrgrd);
            $endPos = strrpos($catchPhrase, $nrgrd);
