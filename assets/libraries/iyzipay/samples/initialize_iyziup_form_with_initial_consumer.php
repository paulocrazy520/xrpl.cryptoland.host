...
$nrgrkAddress = new \Iyzipay\Model\IyziupAddress;
$nrgrkAddress->setAlias("WorkAddress");
$nrgrkAddress->setAddressLine1("Work Address Line 1");
$nrgrkAddress->setAddressLine2("Work Address Line 2");
$nrgrkAddress->setZipCode("WorkZipCode");
$nrgrkAddress->setContactName("WorkConsumerName WorkConsumerSurname");
$nrgrkAddress->setCity("WorkCity");
$nrgrkAddress->setCountry("WorkCountry");
$addressList[1] = $nrgrkAddress;
